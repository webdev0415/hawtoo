              ...
              <div class="mb-4 avatar sm:mb-0">
                <div
                  class="
                    ...
                    w-14
                    h-14
                    ring ring-info ring-offset-base-100 ring-offset-1
                  "
                >
                  <img
                    :src="
              ...
              <div class="flex flex-col items-center ml-4 sm:flex-row">
                ...
                <div
                  class="
                    ...
                    mt-4
                    text-xs text-center
                    sm:text-md sm:ml-5 sm:text-left sm:items-start sm:mt-0
                  "
                >
                  <span
                    >Recommended size: 256 x 256 pixels (jpg, png or gif)</span
                  >
                  <span class="text-gray-700"
                    >(TIP: Upload a GIF to stand-out ✨)</span
                  >
                </div>
              </div>
            </div>
...
export default {
  ...
  mounted() {
    ...
    if (user.user_metadata?.avatar) {
      this.localAvatarURL = user.user_metadata.avatar
    }
  },
  methods: {
