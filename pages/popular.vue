    ...
    <div class="px-4 py-24 mx-auto max-w-7xl sm:px-6 lg:px-8">
      <div class="sm:flex sm:flex-col sm:align-center">
        ...
        <div class="relative self-center mt-6 bg-gray-100 rounded-lg p-0.5 flex sm:mt-8">
          <button type="button" class="relative w-1/2 py-2 text-sm font-medium text-gray-900 bg-white border-gray-200 rounded-md shadow-sm whitespace-nowrap focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:z-10 sm:w-auto sm:px-8">Monthly billing</button>
      ...
      <div class="mt-12 space-y-4 sm:mt-16 sm:space-y-0 sm:grid sm:grid-cols-2 sm:gap-6 lg:max-w-4xl lg:mx-auto xl:max-w-none xl:mx-0 xl:grid-cols-4">
        <div class="border border-gray-200 divide-y divide-gray-200 rounded-lg shadow-sm">
          <div class="p-6">
            ...
            <a href="#" class="block w-full py-2 mt-8 text-sm font-semibold text-center text-white bg-gray-800 border border-gray-800 rounded-md hover:bg-gray-900">Buy Hobby</a>
          </div>
        ...
        <div class="border border-gray-200 divide-y divide-gray-200 rounded-lg shadow-sm">
          <div class="p-6">
            ...
            <a href="#" class="block w-full py-2 mt-8 text-sm font-semibold text-center text-white bg-gray-800 border border-gray-800 rounded-md hover:bg-gray-900">Buy Freelancer</a>
          </div>
          <div class="px-6 pt-6 pb-8">
            <h3 class="text-xs font-medium tracking-wide text-gray-900 uppercase">What's included</h3>
            <ul role="list" class="mt-6 space-y-4">
        ...
        <div class="border border-gray-200 divide-y divide-gray-200 rounded-lg shadow-sm">
          <div class="p-6">
            ...
            <a href="#" class="block w-full py-2 mt-8 text-sm font-semibold text-center text-white bg-gray-800 border border-gray-800 rounded-md hover:bg-gray-900">Buy Startup</a>
          </div>
          <div class="px-6 pt-6 pb-8">
            <h3 class="text-xs font-medium tracking-wide text-gray-900 uppercase">What's included</h3>
            <ul role="list" class="mt-6 space-y-4">
        ...
        <div class="border border-gray-200 divide-y divide-gray-200 rounded-lg shadow-sm">
          <div class="p-6">
            ...
            <a href="#" class="block w-full py-2 mt-8 text-sm font-semibold text-center text-white bg-gray-800 border border-gray-800 rounded-md hover:bg-gray-900">Buy Enterprise</a>
          </div>
          <div class="px-6 pt-6 pb-8">
            <h3 class="text-xs font-medium tracking-wide text-gray-900 uppercase">What's included</h3>
            <ul role="list" class="mt-6 space-y-4">
