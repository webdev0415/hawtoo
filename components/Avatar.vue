...
<template>
  <div class="avatar">
    <!-- verified --->
    <svg v-if="verified" v-tooltip="showVerifiedTooltip ? 'Verified' : ''" class="z-10 verified-badge" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" :style="styleBadge">
    ...
    <!-- initials -->
    <div v-if="!hasImage" :style="style" class="flex items-center justify-center w-full text-center text-white rounded-full bg-neutral-focus text-neutral-content">
