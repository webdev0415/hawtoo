...
<template>
  <circle-loader v-if="type === 'circle'" :width="loaderWidth" :height="loaderHeight" :animation="animation" :color="color" />
  <square-loader v-else :width="loaderWidth" :height="loaderHeight" :animation="animation" :type="type" :color="color" :rounded="rounded" :radius="radius" />
</template>

<script>
import CircleLoader from './SkeletonCircle.vue'
import SquareLoader from './SkeletonStraight.vue'
